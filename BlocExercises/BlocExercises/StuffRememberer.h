...
@property (nonatomic, strong) NSMutableArray *memorableArray;
@property (nonatomic, copy) NSMutableArray *copycatArray;
@property (nonatomic,strong) NSNumber *floatToRemember;
